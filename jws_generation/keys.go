...
// defaultPackageDir returns the directory containing this package's source (jws_generation folder).
...
// Returns the public key and certificate serial number for JWS verification.
...
// Used for verifying PayNet response JWS.
